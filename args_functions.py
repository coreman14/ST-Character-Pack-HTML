"Function realating to parsing the command line"
import argparse
import base64
import builtins
import os
...
def get_args() -> argparse.Namespace:
    ...
    argroup.add_argument(
        ...
        help=(
            ...
            f"This switch will replace the default order. Current order, from left to right, is: {path_functions.OUTFIT_PRIO}",
        ),
        nargs="+",
    )
...
def setup_args(args: argparse.Namespace) -> dict:
    "After args are parsed, do any maintence or make changes based on switches"
